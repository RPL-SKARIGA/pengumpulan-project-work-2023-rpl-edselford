...
data class ThemeColors(
    ...
    val light_CustomColor1: Color,
    val light_onCustomColor1: Color,
    val light_CustomColor1Container: Color,
    val light_onCustomColor1Container: Color,
    val dark_CustomColor1: Color,
    val dark_onCustomColor1: Color,
    val dark_CustomColor1Container: Color,
    val dark_onCustomColor1Container: Color
)
