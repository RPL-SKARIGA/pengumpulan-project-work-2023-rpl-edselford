...
fun ShopPulsa(
    ...
    var op by remember { mutableStateOf<Pair<String, String>?>(null) }
    ...
    fun setOperator() {
        println(phoneNumber)
        op = try {
            println(phoneNumber.substring(0 until 4))
            OPERATOR.find { it.first == phoneNumber.substring(0 until 4) }
        } catch (e: Exception) {
            null
        }
    }
                    ...
                    if (op != null)
                        Image(
                            ...
                            painter = painterResource(
                                id = when (op!!.second) {
                                    "Telkomsel" -> R.drawable.telkomsel
                                    "Indosat" -> R.drawable.indosat
                                    "XL Axiata" -> R.drawable.xl_axiata
                                    "AXIS" -> R.drawable.axis
                                    "Smartfren" -> R.drawable.smartfren
                                    else -> 0
                                }
                            ), contentDescription = ""
                        )
                    ...
                    (if (op != null) listOf(
                        ...
                        Box(
                            modifier = Modifier
                                ...
                                .padding(
                                    vertical = 30.dp,
                                    horizontal = if (width <= 600.dp) 30.dp else 0.dp
                                )
                        ) {
